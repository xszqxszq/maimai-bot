...
package xyz.xszq.xyz.xszq.maimai
...
import xyz.xszq.maimai.MaimaiPlayScore
import xyz.xszq.maimai.MaimaiPlayerData
import xyz.xszq.maimai.fillEmpty
import xyz.xszq.xyz.xszq.maimai.MaimaiImage.resolveCover
...
object MaimaiConfig: AutoSavePluginConfig("maimai") {
    val b40 by value(MaimaiBestPicConfig("b40_bg.png",
        160, 16.0/9
    ).apply {
    ...
    val b50 by value(MaimaiBestPicConfig("b50_bg.png",
        190, 16.0/9
    ).apply {
